...
4. If Docker was used, confirm its `--rm` container exited. Do not stop unrelated containers.
5. Confirm `git status --short` contains only intentional project changes.
