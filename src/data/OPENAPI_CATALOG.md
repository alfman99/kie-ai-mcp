...
| POST | `/api/v1/jobs/createTask` | bytedance-v1-lite-image-to-video | [Bytedance - V1 Lite Image to Video](<https://docs.kie.ai/market/bytedance/v1-lite-image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | bytedance-v1-lite-text-to-video | [Bytedance - V1 Lite Text to Video](<https://docs.kie.ai/market/bytedance/v1-lite-text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | bytedance-v1-pro-fast-image-to-video | [Bytedance V1 Pro Fast Image to Video](<https://docs.kie.ai/market/bytedance/v1-pro-fast-image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | bytedance-v1-pro-image-to-video | [Bytedance V1 Pro Image to Video](<https://docs.kie.ai/market/bytedance/v1-pro-image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | bytedance-v1-pro-text-to-video | [Bytedance - V1 Pro Text to Video](<https://docs.kie.ai/market/bytedance/v1-pro-text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | elevenlabs-audio-isolation | [elevenlabs/audio-isolation](<https://docs.kie.ai/market/elevenlabs/audio-isolation.md>) |
| POST | `/api/v1/jobs/createTask` | elevenlabs-text-to-dialogue-v3 | [elevenlabs/text-to-dialogue-v3](<https://docs.kie.ai/market/elevenlabs/text-to-dialogue-v3.md>) |
| POST | `/api/v1/jobs/createTask` | elevenlabs-text-to-speech-multilingual-v2 | [elevenlabs/text-to-speech-multilingual-v2](<https://docs.kie.ai/market/elevenlabs/text-to-speech-multilingual-v2.md>) |
| POST | `/api/v1/jobs/createTask` | elevenlabs-text-to-speech-turbo-2-5 | [elevenlabs/text-to-speech-turbo-2-5](<https://docs.kie.ai/market/elevenlabs/text-to-speech-turbo-2-5.md>) |
| POST | `/api/v1/jobs/createTask` | flux-2-flex-image-to-image | [Flux-2 - Image to Image](<https://docs.kie.ai/market/flux2/flex-image-to-image.md>) |
| POST | `/api/v1/jobs/createTask` | flux-2-flex-text-to-image | [Flux-2 - Text to Image](<https://docs.kie.ai/market/flux2/flex-text-to-image.md>) |
| POST | `/api/v1/jobs/createTask` | flux-2-pro-image-to-image | [Flux-2 - Pro Image to Image](<https://docs.kie.ai/market/flux2/pro-image-to-image.md>) |
...
| POST | `/api/v1/jobs/createTask` | grok-imagine-image-to-video | [Grok Imagine Image to Video](<https://docs.kie.ai/market/grok-imagine/image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | grok-imagine-text-to-image | [Grok Imagine - Text to Image](<https://docs.kie.ai/market/grok-imagine/text-to-image.md>) |
| POST | `/api/v1/jobs/createTask` | grok-imagine-text-to-video | [Grok Imagine Text to Video](<https://docs.kie.ai/market/grok-imagine/text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | grok-imagine-upscale | [Grok Imagine - Video Upscale](<https://docs.kie.ai/market/grok-imagine/upscale.md>) |
| POST | `/api/v1/jobs/createTask` | hailuo-02-image-to-video-pro | [Hailuo Pro Image to Video](<https://docs.kie.ai/market/hailuo/02-image-to-video-pro.md>) |
| POST | `/api/v1/jobs/createTask` | hailuo-02-image-to-video-standard | [Hailuo Standard Image to Video](<https://docs.kie.ai/market/hailuo/02-image-to-video-standard.md>) |
| POST | `/api/v1/jobs/createTask` | hailuo-02-text-to-video-pro | [Hailuo Pro Text to Video](<https://docs.kie.ai/market/hailuo/02-text-to-video-pro.md>) |
| POST | `/api/v1/jobs/createTask` | hailuo-02-text-to-video-standard | [Hailuo Standard Text to Video](<https://docs.kie.ai/market/hailuo/02-text-to-video-standard.md>) |
| POST | `/api/v1/jobs/createTask` | hailuo-2-3-image-to-video-pro | [Hailuo 2.3 Pro Image to Video](<https://docs.kie.ai/market/hailuo/2-3-image-to-video-pro.md>) |
| POST | `/api/v1/jobs/createTask` | hailuo-2-3-image-to-video-standard | [Hailuo 2.3 Standard Image to Video](<https://docs.kie.ai/market/hailuo/2-3-image-to-video-standard.md>) |
| POST | `/api/v1/jobs/createTask` | playground_252 | [HappyHorse-1-1 image-to-video](<https://docs.kie.ai/market/happyhorse-1-1/image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | playground_254 | [HappyHorse-1-1 reference-to-video](<https://docs.kie.ai/market/happyhorse-1-1/reference-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | playground_253 | [HappyHorse-1-1 text-to-video](<https://docs.kie.ai/market/happyhorse-1-1/text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | happyhorse-image-to-video | [HappyHorse - image-to-video](<https://docs.kie.ai/market/happyhorse/image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | happyhorse-reference-to-video | [HappyHorse - reference-to-video](<https://docs.kie.ai/market/happyhorse/reference-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | happyhorse-text-to-video | [HappyHorse - text-to-video](<https://docs.kie.ai/market/happyhorse/text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | happyhorse-video-edit | [HappyHorse - video-edit](<https://docs.kie.ai/market/happyhorse/video-edit.md>) |
| POST | `/api/v1/jobs/createTask` | ideogram-character-edit | [Ideogram - Character Edit](<https://docs.kie.ai/market/ideogram/character-edit.md>) |
| POST | `/api/v1/jobs/createTask` | ideogram-character-remix | [Ideogram - Character Remix](<https://docs.kie.ai/market/ideogram/character-remix.md>) |
| POST | `/api/v1/jobs/createTask` | ideogram-character | [Ideogram - Character](<https://docs.kie.ai/market/ideogram/character.md>) |
| POST | `/api/v1/jobs/createTask` | ideogram-v3-edit | [Ideogram V3 Edit](<https://docs.kie.ai/market/ideogram/v3-edit.md>) |
| POST | `/api/v1/jobs/createTask` | ideogram-v3-remix | [Ideogram V3 Remix](<https://docs.kie.ai/market/ideogram/v3-remix.md>) |
| POST | `/api/v1/jobs/createTask` | ideogram-v3-text-to-image | [Ideogram V3 Text to Image](<https://docs.kie.ai/market/ideogram/v3-text-to-image.md>) |
| POST | `/api/v1/jobs/createTask` | infinitalk-from-audio | [Infinitalk - From Audio](<https://docs.kie.ai/market/infinitalk/from-audio.md>) |
...
| POST | `/api/v1/jobs/createTask` | kling-v2-1-master-image-to-video | [Kling V2.1 Master Image to Video](<https://docs.kie.ai/market/kling/v2-1-master-image-to-video.md>) |
...
| POST | `/api/v1/jobs/createTask` | pixverse-v6-video-extension | [PixVerse V6 Video Extension](<https://docs.kie.ai/market/pixverse/extend.md>) |
| POST | `/api/v1/jobs/createTask` | pixverse-v6-image-to-video | [PixVerse V6 Image-to-Video](<https://docs.kie.ai/market/pixverse/image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | pixverse-v6-fusion-reference-to-video | [PixVerse V6 Fusion / Reference-to-Video](<https://docs.kie.ai/market/pixverse/reference-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | pixverse-v6-text-to-video | [PixVerse V6 Text-to-Video](<https://docs.kie.ai/market/pixverse/text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | pixverse-v6-first-last-frame-transition | [PixVerse V6 First & Last Frame Transition](<https://docs.kie.ai/market/pixverse/transition.md>) |
...
| POST | `/api/v1/jobs/createTask` | bytedance-seedream | [Seedream3.0 - Text to Image](<https://docs.kie.ai/market/seedream/seedream.md>) |
...
| POST | `/api/v1/jobs/createTask` | wan-2-5-text-to-video | [Wan 2.5 - Text to Video](<https://docs.kie.ai/market/wan/2-5-text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | wan-2-6-flash-image-to-video | [Wan - 2.6-flash-image-to-video](<https://docs.kie.ai/market/wan/2-6-flash-image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | wan-2-6-flash-video-to-video | [Wan - 2-6-flash-video-to-video](<https://docs.kie.ai/market/wan/2-6-flash-video-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | wan-2-6-image-to-video | [Wan 2.6 - Image to Video](<https://docs.kie.ai/market/wan/2-6-image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | wan-2-6-text-to-video | [Wan 2.6 - Text to Video](<https://docs.kie.ai/market/wan/2-6-text-to-video.md>) |
| POST | `/api/v1/jobs/createTask` | wan-2-6-video-to-video | [Wan 2.6 - Video to Video](<https://docs.kie.ai/market/wan/2-6-video-to-video.md>) |
| POST | `/api/v1/jobs/createTask` |  | [Wan 2.7 Image Pro](<https://docs.kie.ai/market/wan/2-7-image-pro.md>) |
| POST | `/api/v1/jobs/createTask` | wan-2-7-image-to-video | [Wan 2.7 - Image to Video](<https://docs.kie.ai/market/wan/2-7-image-to-video.md>) |
| POST | `/api/v1/jobs/createTask` |  | [Wan 2.7 Image](<https://docs.kie.ai/market/wan/2-7-image.md>) |
